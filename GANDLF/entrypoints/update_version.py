...
@click.command()
@click.option('--old-version', '-ov',  # TODO: renamed from --old_version
              required=True,
              help="The old version number")
@click.option('--new-version', '-nv',  # TODO: renamed from --new_version
              required=True,
...
@deprecated("This is a deprecated way of running GanDLF. Please, use `gandlf update-version` cli command " +
