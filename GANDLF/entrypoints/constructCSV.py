...
def _construct_csv(
    ...
    writeTrainingCSV(input_dir,
                     channels_id,
                     label_id,
                     output_file,
                     relativize_paths_to_output)
...
@deprecated("This is a deprecated way of running GanDLF. Please, use `gandlf construct-csv` cli command " +
